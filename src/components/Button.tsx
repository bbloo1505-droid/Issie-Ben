...
type Variant = 'primary' | 'secondary' | 'outlineLight' | 'ghost' | 'cta' | 'ctaQuiet' | 'ctaOlive';
...
const variants: Record<Variant, string> = {
  ...
  ctaOlive:
    'min-h-[3.25rem] rounded-lg bg-olive px-8 text-sm font-bold uppercase tracking-[0.12em] text-gold hover:bg-olive-deep sm:min-h-[3.5rem]',
  outlineLight:
